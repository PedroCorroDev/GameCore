...
if ($comprobacionUsuario == true || $comprobacionEmail == true || $comprobacionTelefono == true){
    header("Location: " . dirname($_SERVER["PHP_SELF"]) . "/../views/registro.php?comprobacionUsuario=".$comprobacionUsuario."&comprobacionEmail=".$comprobacionEmail."&comprobacionTelefono=".$comprobacionTelefono."&voltear=1");
}else{
